 ...
 * @author estudiante1: Akram Hamdouchi
 * @author estudiante2: Pablo Bolaños 
 **/
...
public:
     ...
     * @param y y-coordinate of th e topt left corner. input param
    ...
    void extractObjects(Image imageSet [], int &nimages, int maximages, double tolerance = Histogram::HISTOGRAM_TOLERANCE) const;
